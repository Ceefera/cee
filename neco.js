let students = [
  ...
  if(validCredentials){
    outputDiv.style.display = "block"; //display the result div
    formContainer.style.display= "none";
  }
  else{
    alert("Invalid studentId and Password Combination")
  }
    // console.log(studentId.value)
    // console.log(studentPd.value)
    // console.log(output.value)
    // console.log(resultinfo.value)
    // console.log(formConatiner.value)
    // console.log(valid)
    // console.log(studentId.value)
    // console.log(studentPd.value)
})